    ...
    <header className="h-14 border-b border-border bg-[#0c0c0e]/80 backdrop-blur-md flex items-center justify-between px-6 shrink-0 relative z-50">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          <span className="text-[10px] font-medium text-zinc-500 uppercase tracking-[0.2em] leading-none mb-0.5">NeuralFlow v3.1</span>
          <span className="text-sm font-bold tracking-tight">Zhenyi Intelligence</span>
        </div>
