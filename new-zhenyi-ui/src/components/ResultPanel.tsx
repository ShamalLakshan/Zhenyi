            ...
            <Card className="flex flex-col flex-1 min-h-0 border-zinc-800 shadow-2xl overflow-hidden rounded-2xl rounded-tl-none bg-zinc-900/50 backdrop-blur-3xl">
              <CardHeader className="border-b border-zinc-800 py-3 px-6 flex flex-row items-center justify-between space-y-0 bg-[#0c0c0e]">
                 <div className="flex items-center gap-2">
                   ...
                   <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500">Intelligence Synthesis</CardTitle>
                 </div>
              ...
              <CardContent className="flex-1 overflow-hidden p-0 flex flex-col">
                <ScrollArea className="flex-1">
                  <div className="p-8 prose prose-slate dark:prose-invert max-w-none text-base leading-relaxed text-foreground/90">
                    {answer.split('\n\n').map((para, i) => (
                ...
                <div className="h-32 px-8 pt-4 border-t border-zinc-800 bg-[#0c0c0e]/30">
                ...
                <div className="px-8 pb-5 border-t border-zinc-800 bg-[#0c0c0e]/10 grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
