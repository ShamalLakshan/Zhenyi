      ...
      <div className="p-4 border-b border-zinc-800 space-y-4 shrink-0 bg-[#0c0c0e]/50">
        ...
        <div className="relative">
          ...
          <input 
            ...
            className="w-full bg-[#09090b] border border-zinc-800 h-9 pl-10 pr-4 rounded-xl text-[11px] outline-none focus:border-primary/50 transition-colors font-medium text-zinc-300"
            value={filter}
              ...
              <div className="p-5 flex flex-col h-full gap-4">
                ...
                <ScrollArea className="flex-1 bg-zinc-900/50 rounded-xl p-4 border border-zinc-800">
                  <div className="text-[12px] leading-relaxed text-zinc-300 whitespace-pre-wrap font-medium">
                    {selectedChunk.text || selectedChunk.content || 'Analytical content restricted or unavailable in the current view.'}
                  </div>
                </ScrollArea>
